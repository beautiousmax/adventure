items = {"master": {"a rock": {"rarity": "super common", "plural": "rocks"},
         ...
         "forest": {"a pinecone": {"rarity": "super common", "plural": "pinecones", "flammable": True},
                    ...
                    "some mysterious berries": {"rarity": "uncommon",
                                                "plural": "bushes full of mysterious berries", "type": "food"},
         ...
         "city": {"a wad of gum": {"rarity": "super common", "plural": "wads of gum"},
                  ...
                  "a magic pill": {"rarity": "rare", "plural": "magic pills", "type": "food"}},
...
buildings = {"master": {"a car dealership": {"rarity": "rare",
             ...
             "city": {"a bar": {"type": "building",
                      ...
                      "a starbucks": {"type": "building",
                                      "rarity": "common",
                                      "plural": "starbucks",
                                      "wares": {"cup of coffee": {"price": 5, "type": "food",
                                                                  "rarity": "super common",
                                                                  "plural": "cups of coffee"},
                                                "fat free muffin": {"price": 4, "type": "food",
                                                                    "rarity": "super common",
                                                                    "plural": "fat free muffins"}}},
                      "a blacksmith": {"type": "building", "rarity": "uncommon",
                                       "plural": "blacksmiths"}
                      },
             "ocean": {"a volcanic base": {"rarity": "super rare",
                                           "plural": "volcanic bases", "type": "building",
             ...
             "mountains": {"an ancient temple": {"rarity": "super rare",
                                                 "plural": "ancient temples", "type": "building",
                                                 "jobs": {"priest": {"skills needed": ["patience", "intelligence"]}}},
                           "a wind power farm": {"rarity": "rare", "plural": "wind power farms", "type": "building"}},
             "forest": {"a hunting lodge": {"rarity": "uncommon",
                                            "plural": "hunting lodges", "type": "building"}},
             "desert": {"a silk tent": {"rarity": "uncommon",
                                        "plural": "silk tents", "type": "residence"}},
             "swamp": {"a shed": {"rarity": "uncommon", "plural": "sheds", "type": "building"}}
             }
